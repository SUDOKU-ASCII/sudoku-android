...
2. Run `scripts/build_sudoku_aar.sh`, which clones upstream `sudoku` at `SUDOKU_REF` (default: `v0.1.0`), executes `gomobile bind -target=android/arm64,android/amd64 ./pkg/mobile`, and drops the AAR into `app/libs/`.
